...
export class Matrix4 {
	...
	public reset(): void {
		for (let i = 0; i < 16; ++i) this.values[i] = 0
	}
	...
	public ortho(l: number, r: number, t: number, b: number, near: number, far: number): void {
		const rl: number = r - l
		const tb: number = t - b
	...
	public translate(vec: Vector2): void {
	...
	public getValues = (): Float32Array => this.values
}
